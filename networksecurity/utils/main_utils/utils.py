...
def evaluate_models(X_train, y_train, X_test, y_test, models, params=None, param=None):
    try:
        if params is None:
            params = param or {}
        if param is None:
        ...
        for model_name, model in models.items():
            ...
            # Use weighted F1 score for classification model selection
